...
public class WeaponsController {
    ...
    public ResponseEntity<WeaponResponse> createWeapon(
        ...
        // Crear URI de ubicación del recurso creado (buena práctica REST)
    ...
    public ResponseEntity<WeaponResponse> replaceWeapon(
        ...
        // Verificar si el arma existe para determinar el código de estado apropiado
        ...
        // 200 OK si existe, 201 Created si se creó nuevo
        ...
        // Agregar Location header si es nuevo recurso
        if (!weaponExists) {
