    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("API REST Gateway para el Codex de armas de Zelda Breath of the Wild con autenticación OAuth2")
                .version("v1.0.0")
                .contact(new Contact()
                    .name("Zelda API Team")
                    .email("admin@zelda-api.com")
                    .url("https://github.com/your-org/zelda-codex-api"))
                .license(new License()
                    .name("MIT License")
